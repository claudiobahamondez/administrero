 ...
 * @author ec1697
 */
public class V_CartonLPN extends javax.swing.JDialog {
    ...
    public V_CartonLPN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("INFORMAR CARTÓN");
        ...
        cbMotivo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cíclico", "Daño", "Error de sistema", "Ext para cumplir", "Extravío", "Faltante", "Faltante (Paris)", "Hurto", "Incompleto", "No en ubicación", "Tarea canc", "-" }));
        cbMotivo.setSelectedIndex(9);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CARTON", "CANT", "SKU", "DESCRIPCION", "UBIC", "LPN"
            }
        ));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String condicionero = " WHERE LPN IS NULL ";
        ...
        if (this.tieneVacios()) {
            ...
            JOptionPane.showMessageDialog(null, "La cantidad debe ser superior a 0");
                ...
                for (int i = 0; i < this.jTable2.getRowCount(); ++i) {
                    String CARTON = this.jTable2.getValueAt(i, 0).toString().replace(" ", "").toUpperCase();
                    ...
                    String LPN = this.jTable2.getValueAt(i, 5).toString().replace(" ", "").toUpperCase();
                    condicionero = condicionero + " OR LPN='"+LPN+"' ";
                    
                    String aux [] = new String [6];
                    aux[0]=LPN;aux[1]=SKU;aux[2]=DESC;aux[3]=CANT;aux[4]=UBIC;aux[5]=CARTON;
                    System.out.println(LPN+"\t"+SKU+"\t"+DESC+"\t"+CANT+"\t"+UBIC+"\t"+CARTON);
                    laMatriz.add(aux);
                    losLPN.add(LPN);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_CartonLPN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_CartonLPN dialog = new V_CartonLPN(new javax.swing.JFrame(), true);
...
public void validarTodo(ArrayList matriz, ArrayList lpns, String condicionero, String motivo, String zona, String area, String supervisor){
    ...
    try {
            String sql1 = "SELECT LPN, SKU, QTY FROM LPN "+condicionero+" ORDER BY LPN";
            ...
            while (r.next()) {
                ...
                String CARTON = dameSUDAMERICANAORIGINAL(LPN_VALIDO, matriz, pos);
                if(QTY_VALIDO<1){
...
public String dameUBICORIGINAL(String lpi, ArrayList matriz, int posicion){
 ...
 public String dameSUDAMERICANAORIGINAL(String lpi, ArrayList matriz, int posicion){
    String resp = "";
    String aux[] = (String []) matriz.get(posicion);
    String kartoon = aux[5];
    resp = kartoon;
    return resp;  
}   
